...
class Tb3_image_sub(Node):
    def __init__(self):
        ...
        self.cb = CvBridge()
        self.traffic = cv2.imread('images/traffic_stop.png')
    ...
    def sub_message(self, msg):
        ...
        orbF = cv2.ORB_create(nfeatures=300)
        kp1, des1 = orbF.detectAndCompute(self.traffic, None)
        kp2, des2 = orbF.detectAndCompute(current_frame, None)
