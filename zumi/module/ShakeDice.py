...
# 주사위 흔들기
def shaking_dice(sensitivity = 20, range = 6):
    ...
    if(sensitivity > 120 or sensitivity < 1):
        ...
        old_angleX = int(zumi.update_angles()[0])
        old_angleY = int(zumi.update_angles()[1])  
        ...
        while True:
            ...
            # 자이로 각도 값을 읽어옵니다.    
            current_angleX = int(zumi.update_angles()[0])
            current_angleY = int(zumi.update_angles()[1])
            ...
            # 흔들림이 생기고 멈출 때까지 감지합니다.
                ...
                if shake == True:
                    ...
                    message = "   Dice Number          "
                    screen.draw_text(message + str(diceNumber))   
